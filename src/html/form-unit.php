...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        ...
        $baseDirectory = "http://localhost/modern/pinjam/src/html/unit";
                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($query)) : ?>
                                            <tr>
                                                ...
                                                <td class="border-bottom-0">
                                                    <button type="button" class="btn btn-primary m-1" data-bs-toggle="modal" data-bs-target="#updateModal<?php echo $row['id_unit']; ?>">
                                                        Update
                                                    </button>
                                                </td>
                                                <td class="border-bottom-0">
